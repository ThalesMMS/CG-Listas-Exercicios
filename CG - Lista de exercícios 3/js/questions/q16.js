  ...
  function build() {
    return [
      S.concept({
        ...
        body:
          "<p>Na animação por <b>key framing</b>, o animador define só os <b>momentos " +
          "importantes</b> (key frames); o resto é preenchido por <b>interpolação</b>.</p>" +
      ...
      }),
      {
        ...
        body:
          ...
          "momentos críticos.</p>" +
          "<p>São criados pelo <b>animador</b> (à mão) e determinam o <b>movimento essencial</b>. " +
          "São poucos.</p>",
        visual: svgStep(["key"]),
      },
      {
        ...
        body:
          "<p>São os quadros <b>entre</b> os key frames, gerados por <b>interpolação</b> (linear " +
          "ou por <i>splines</i>) — o chamado <i>tweening</i>.</p>" +
          "<p>Tradicionalmente desenhados por assistentes; hoje calculados pelo <b>computador</b>. " +
          "Completam a transição suave e são muitos.</p>",
