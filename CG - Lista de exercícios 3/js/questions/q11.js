  ...
  function build() {
    return [
      S.concept({
        ...
        body:
          "<p>No sombreamento <b>Flat (constante)</b>, calcula-se <b>uma única intensidade por " +
          "polígono</b> — usando a normal da face, avaliada uma vez (em geral no centroide).</p>" +
          "<p>O resultado: cada face fica com uma cor <b>chapada</b>, e as facetas ficam visíveis " +
          "em superfícies curvas (ao lado).</p>",
        visual: svgStep("all"),
      }),
      {
        ...
        body:
          ...
          "transições.</p>" +
          "<p>É o método de sombreamento <b>mais barato</b>.</p>",
      ...
      },
      {
        ...
        body:
          ...
          "orientação única.</p>" +
          "<p>Aqui não há \"erro\": as facetas são o objeto.</p>",
        visual: svgStep(["cube"]),
      },
      S.prosCons({
