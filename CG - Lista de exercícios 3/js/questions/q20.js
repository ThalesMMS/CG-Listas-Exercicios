    ...
    return [
      ...
      }),
      {
        ...
        body:
          ...
          "final</b> (a \"mão\"/ponta).</p>" +
          "<p>É a <b>composição das transformações</b> ao longo da hierarquia — solução " +
          "<b>direta e única</b>, fácil de calcular.</p>",
        visual: svgStep("dir"),
      },
      {
        title: "Cinemática inversa (inverse)",
        body:
          "<p>Dada a <b>posição-alvo</b> do efetuador final, calculam-se os <b>ângulos das " +
          "juntas</b> necessários para alcançá-la.</p>" +
          "<p>É o problema <b>inverso</b>, geralmente <b>não-linear</b>: pode ter <b>múltiplas " +
          "soluções, infinitas ou nenhuma</b>. Resolve-se por métodos analíticos ou iterativos. " +
          "Mais difícil, porém essencial para <b>posicionar a mão/pé num alvo</b>.</p>",
        visual: svgStep("inv"),
      },
      S.comparison({
        ...
        rows: [
          ...
          ["Cálculo", "Direto e único", "Não-linear; múltiplas/infinitas/nenhuma solução"],
