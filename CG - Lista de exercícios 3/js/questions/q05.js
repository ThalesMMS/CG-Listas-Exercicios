    ...
    return [
      S.concept({
        ...
        body:
          ...
          "<b>raio a partir da câmera/observador</b>, atravessando aquele pixel rumo à cena.</p>" +
      ...
      }),
      {
        ...
        body:
          ...
          "posicionada à frente da <span class='accent'>câmera</span>.</p>" +
          "<p>Cada pixel é uma \"janela\" por onde olhamos a cena.</p>",
      ...
      },
      {
        ...
        body:
          "<p>Ao seguir o raio, ficamos com a <b>primeira interseção</b> (a mais próxima do olho). " +
          "Esse é o objeto <b>visível</b> naquele pixel — as superfícies atrás ficam " +
          "<b>ocultas</b> automaticamente.</p>" +
          "<p>A cor do objeto atingido é gravada no pixel. A visibilidade sai \"de graça\".</p>",
        visual: svgStep(["scene", "cam", "rays", "hit"]),
      },
      S.concept({
        title: "3) Eficiência — só processa o que é visível",
        body:
          "<p>Partindo da câmera, só calculamos iluminação para o que <b>chega ao olho</b>. " +
          "Não se gasta tempo com objetos/superfícies que nunca apareceriam.</p>" +
          ...
          "<span class='accent'>(3)</span> eficiência ao processar apenas o visível.</p>",
        visual: svgStep("all"),
      }),
    ];
  }
