  ...
  function build() {
    return [
      ...
      },
      {
        ...
        body:
          "<p>A intensidade total é a soma das três componentes, sobre todas as fontes de luz " +
          "(ao lado, cada termo destacado):</p>",
        visual: formulaDom(null),
      },
      {
        title: "Componente difusa — k_d·I_L·(N·L)",
        body:
          "<p>Modela a reflexão <b>fosca</b> (Lambert). É máxima quando a luz incide " +
          "<b>perpendicular</b> à superfície (N·L = 1) e some na incidência rasante.</p>" +
          "<p>Depende do ângulo <b>θ</b> entre <b>N</b> e <b>L</b> — e <b>não</b> do observador.</p>",
        visual: { type: "svg", draw: function (svg) { drawPhong(svg, "diffuse"); } },
      },
      {
        title: "Componente especular — k_s·I_L·(R·V)^n",
        body:
          "<p>Modela o <b>brilho</b> (highlight). É forte quando o vetor <b>R</b> se alinha ao " +
          "vetor <b>V</b> (ângulo <b>α</b> pequeno).</p>" +
          "<p>O expoente <b>n</b> (shininess) controla o tamanho do brilho: <b>n</b> grande → " +
          "brilho pequeno e concentrado (superfície mais polida).</p>",
