  ...
  function build() {
    return [
      S.concept({
        ...
        body:
          "<p>O cálculo dos in-betweens é barato para o computador. O <b>custo dominante</b> está " +
          "em outro lugar: no <b>trabalho humano</b> e na qualidade do movimento.</p>",
      ...
      }),
      {
        ...
        body:
          ...
          "animador: cada pose precisa ser especificada à mão.</p>" +
          "<p>É <b>trabalhoso, demorado</b> e exige <b>habilidade artística</b> — quanto mais " +
          "poses-chave, mais esforço.</p>",
        visual: svgStep("manual"),
      },
      {
        ...
        body:
          ...
          "complicado. A interpolação <b>linear ingênua</b> gera movimento mecânico, " +
          "<b>autointersecções</b> ou trajetórias erradas (o braço \"encolhe\" e atravessa, em vez " +
          "de girar).</p>" +
          "<p>Corrigir isso exige <b>mais key frames</b> ou ajustar curvas (<i>splines</i>, " +
          "<i>easing</i>) — o que aumenta ainda mais o esforço humano.</p>",
