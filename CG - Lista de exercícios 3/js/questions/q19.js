  ...
  function build() {
    return [
      ...
      }),
      {
        ...
        body:
          "<p>Descreve o <b>movimento em si</b>: <b>posição</b>, <b>velocidade</b>, " +
          "<b>aceleração</b> e trajetória ao longo do tempo.</p>" +
          "<p><b>Não</b> se preocupa com as causas — é puramente <b>geométrica/temporal</b>. " +
          "Em animação, é o animador especificando diretamente como algo se move.</p>",
        visual: svgStep("cin"),
      },
      {
        title: "Dinâmica — as causas",
        body:
          "<p>Estuda <b>as causas</b> do movimento: <b>forças</b>, <b>massas</b> e torques, e como " +
          "produzem aceleração — regida pelas leis de Newton.</p>" +
          "<div class='formula'>F = m · a</div>" +
          "<p>Em animação, o movimento <b>emerge</b> de uma <b>simulação física</b> de forças " +
          "(gravidade, colisões, molas).</p>",
        visual: svgStep("din"),
      },
      S.comparison({
        ...
        rows: [
          ...
          ["Base", "Geometria / tempo", "Leis de Newton (F = m·a)"],
