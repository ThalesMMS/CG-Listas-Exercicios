    ...
    return [
      S.concept({
        ...
        body:
          ...
          "rochas) ainda são, no fim, uma <b>malha poligonal</b> comum — só que com vértices " +
          "definidos por um processo randômico/fractal.</p>" +
          "<p>Por isso os cálculos de <b>iluminação</b> e <b>movimentação</b> seguem o mesmo " +
          "princípio de qualquer malha.</p>",
        visual: svgStep("ilum"),
      }),
      {
        title: "Iluminação: pela normal de cada polígono",
        body:
          "<p>Mesmo gerados aleatoriamente, cada polígono tem <b>vértices</b> bem definidos — e " +
          "deles se calcula a <b>normal</b> da face (ou as normais dos vértices).</p>" +
          "<p>Com a normal em mãos, aplica-se o <b>modelo de iluminação</b> (Phong/Lambert) " +
          "<b>por face</b> (Flat) ou <b>por vértice</b> (Gouraud/Phong). Nada de especial: a " +
          "aleatoriedade só definiu a geometria; o cálculo de luz é o de sempre.</p>",
        visual: svgStep("ilum"),
      },
      {
        title: "Movimentação: transformando os vértices",
        body:
          "<p>O objeto se move por <b>transformações geométricas</b> aplicadas aos <b>vértices</b> " +
          "— translação, rotação e escala via <b>matrizes</b> — movendo a malha inteira como um " +
          "todo (ou animando os vértices).</p>" +
          "<p>As <b>normais</b> são <b>recalculadas/transformadas</b> junto, para a iluminação " +
          "continuar coerente após o movimento. A textura acompanha pelas coordenadas " +
          "<b>(u, v)</b> dos vértices.</p>",
        visual: svgStep("mov"),
      },
      S.comparison({
        title: "Resumo",
        ...
        rows: [
          ["Iluminação", "Normal de cada polígono (dos vértices) + modelo de iluminação por face/vértice"],
          ["Movimentação", "Matrizes de transformação nos vértices; normais transformadas junto"],
          ["Textura", "Segue os vértices pelas coordenadas (u, v)"],
        ],
      }),
    ];
  }
