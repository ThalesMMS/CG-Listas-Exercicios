  ...
  function build() {
    return [
      S.concept({
        ...
        body:
          "<p>A <b>teoria da Gestalt</b> estuda como o sistema visual <b>organiza e agrupa</b> " +
          "estímulos em conjuntos coerentes — fundamental para projetar interfaces, ícones e cenas.</p>" +
      ...
      }),
      {
        ...
        body:
          ...
          "A distância manda mais que a forma: aproximar junta, afastar separa.</p>" +
      ...
      },
      {
        ...
        body:
          "<p>Elementos <b>parecidos</b> — em cor, forma, tamanho ou orientação — são agrupados, " +
          "ainda que distantes.</p>" +
          "<p>Aqui a <b>cor</b> define o agrupamento: percebemos <span class='accent'>colunas</span> " +
          "(azul e laranja), não linhas.</p>",
        visual: svgStep("simil"),
      },
      {
        title: "3) Continuidade",
        body:
          "<p>A visão tende a seguir <b>caminhos contínuos e suaves</b>. Quando linhas se cruzam, " +
          "lemos cada uma como um traço que <b>continua</b>, em vez de \"quebrar\" no cruzamento.</p>" +
      ...
      S.comparison({
        ...
        headers: ["Fator", "Agrupa por…"],
        rows: [
          ["Proximidade", "Distância — o que está perto"],
          ["Similaridade", "Aparência — cor, forma, tamanho"],
          ["Continuidade", "Caminhos suaves e contínuos"],
          ["Fechamento", "Completar formas incompletas"],
        ],
      }),
    ];
  }
